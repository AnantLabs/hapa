...
namespace Automation.Membership
{
    public class MongoMembershipProvider : MembershipProvider
    {
        ...
        {
            get { return "MongoMembershipProvider"; }
            set { ; }
        }
        ...
        public static MongoMembershipUser CreateUser1(string username, string password, string email,
            ...
            var newUser = new MongoMembershipUser
                              {
                                  ...
                                  //EncodePassword(passwordAnswer, (int)PasswordFormat, passwordKey),
        ...
        {
            MongoMembershipUser currentUser = GetUser1(username, false);
            if (currentUser == null)
                return false;
        ...
        {
            return ValidateUser1(username, password);
        }
    }
}